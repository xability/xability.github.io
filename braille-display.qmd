...
1. If you are not one already, enroll to [become an NLS patron](https://www.loc.gov/nls/how-to-enroll/){:target="_blank"}. Be sure to refer to the eligibility criteria and steps outlined on that page before you apply.
2. Once you are enrolled by the NLS as a patron and have access to their services, find your [network library's contact information from this page](https://www.loc.gov/nls/find-your-library/){:target="_blank"}.
...
For more information about this process, or to learn about available NLS equipment and other device recommendations from the NLSk, check out this [Equipment for NLS Materials page](https://www.loc.gov/nls/services-and-resources/equipment-for-nls-materials/){:target="_blank"}.
